...
![edge_burr_amplitude](output/param_showcase/gen_edge_burr_amplitude_—_Edge_Roughness_Amplitude_20×.png)

> 以上为 20× 视场下的对比 (mag_factor=2.0, 8-16 个畴区, r=75-125px)，畴区更大，毛刺效果更明显。
...
![edge_burr_subdivisions](output/param_showcase/gen_edge_burr_subdivisions_—_Edge_Subdivision_Density_20×.png)

> 以上为 20× 视场下的对比。

> **联合调参**: 当前默认 `amplitude=0.08, subdivisions=4` 产生自然的晶粒边缘。以上对比图使用 20× 视场 (mag_factor=2.0)，畴区更大，毛刺效果更明显。
...
![max_overlap_ratio](output/param_showcase/gen_max_overlap_ratio_—_Max_Overlap_Ratio_20×.png)

> 以上为 20× 视场下的对比，畴区更大，重叠效果更易观察。
...
![max_overlap_count](output/param_showcase/gen_max_overlap_count_—_Max_Pixel_Coverage_Layers_20×.png)
...
![contain_threshold](output/param_showcase/gen_contain_threshold_—_Containment_Threshold_20×.png)
